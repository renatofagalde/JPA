 ...
 **/
public class ConsultaModeloCarroFiltroINObjeto {
	...
	public static void main(String[] args) {
		...
		List<String> list = entityManager.createQuery("select mc.descricao from ModeloCarro mc where mc.fabricante.nome='Honda' and mc.categoria in ('MINIVAN')", String.class).getResultList();
